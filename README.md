Yêu cầu để chạy lab là bạn có docker desktop, nếu chưa có thì hãy tải ở link này : https://www.docker.com/products/docker-desktop
Sau khi tải hãy cài đặt rồi bật CMD chạy "docker --version" nếu hiện ra version của docker thì có thể chạy lab
